...
var config ={
    ...
    snrEnd :10, // 10 snr worse quality
    finishIfReversalIs:7, // use 7 as recommended by Levit t , H. (1992).
    exportFileName:"export.csv",
    testStartAtSNR:5, // The first question will have snr of testStartAtSNR, to start at beginning put 1
    debug:true
}
...
function submitAnsJnd(qNum,snr, correct_num){
	...
	if (!document.querySelector('input[name="num_'+qNum+'"]').value){
		alert("Please enter the number you seen.");
		return;
	}
	//disable next button
